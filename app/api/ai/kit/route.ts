...
export async function POST(request: Request) {
  ...
  const SECTIONS_BY_FILE: Record<string, UssSection[]> = {
    ...
    "architecture.md": ["architecture", "decisions", "constraints", "complexity", "capabilities"],
    ...
    "code-standards.md": ["architecture", "constraints", "complexity"],
    "ai-workflow-rules.md": ["complexity", "decisions", "openDecisions"],
